...
subtitulo = tk.Label(encabezado, text="Concesiones • Permisos • Incidencias", bg=color_header, fg="#BDC3C7", font=("Segoe UI", 21))
subtitulo.pack()
...
def mostrar_formulario_agregar(tipo, items):
    ...
    def guardar():
        ...
        if not id_val or not nombre or not desc:
            messagebox.showerror("Error", "PORFAVOR DE COMPLETAR TODOS LOS CAMPOS")
            return
